...
const char *const SERVER1_METHOD_SUB_NAME = "sub";
...
int main(int argc, char **argv) {
    ...
    // Sub method from server1
    printf("Enter two numbers to be subtracted: ");
    scanf("%d %d", &a, &b);

    msg = dbus_message_new_method_call(SERVER1_BUS_NAME, SERVER1_OBJECT_PATH_NAME, SERVER1_INTERFACE_NAME, SERVER1_METHOD_SUB_NAME);
